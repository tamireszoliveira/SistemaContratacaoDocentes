...
public class TelaAddDisciplina extends JFrame {
	...
	public TelaAddDisciplina() {
		...
		txtpnDisciplina.setText("Digite o nome da disciplina");
		...
		txtpnDigiteO.setText("Digite o código da disciplina");
		...
		txtpnDigiteODia.setText("Selecione o dia da semana");
		...
		txtpnDigiteOHorrio.setText("Digite o horário inicial da disciplina");
		...
		txtpnDigiteAQuantidade.setText("Digite a quantidade de horas semanais");
		...
		txtpnSelecioneOCurso.setText("Selecione o curso");
